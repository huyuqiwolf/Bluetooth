...
import com.ken.demo.bluetooth.adapter.DeviceAdapter;

import java.util.ArrayList;
import java.util.List;

public class FindDeviceActivity extends AppCompatActivity implements DeviceAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bluetoothAdapter != null && !bluetoothAdapter.isEnabled()) {
            ...
            startActivityForResult(new Intent(BluetoothAdapter.ACTION_REQUEST_DISCOVERABLE), ENABLE_DISCOVERABLE);
        }
    }
